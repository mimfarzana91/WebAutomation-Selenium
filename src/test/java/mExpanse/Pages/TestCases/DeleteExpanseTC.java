...
import mExpanse.Pages.Implementation.DeleteExpanse_Impl;
...
public class DeleteExpanseTC extends BaseClass {
    ...
    DeleteExpanse_Impl deleteExpanse = new DeleteExpanse_Impl();
    ...
    @Test(priority = 4)
    public void openDeleteUnreportedExpanse() throws InterruptedException {
        deleteExpanse.openDeleteUnreportedExpanse(driver);
    }

    @Test(priority = 5)
    public void DeleteUnreportedExpanse() throws InterruptedException {
        deleteExpanse.deleteUnreportedExpanse(driver);
    }
